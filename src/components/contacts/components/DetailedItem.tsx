          ...
          <div>
            ...
            <div className={styles.itemWebsite}>
              ...
              {socialLinks.facebook && (
                <Link href={socialLinks.facebook} target="_blank" rel="noopener">
                  <FacebookIcon
              ...
              {socialLinks.instagram && (
                <Link href={socialLinks.instagram} target="_blank" rel="noopener">
                  <InstagramIcon
                    sx={(theme) => ({ color: theme.palette.text.secondary, mt: '0.25rem' })}
                    fontSize="small"
                  />
              ...
              {socialLinks.linkedin && (
                <Link href={socialLinks.linkedin} target="_blank" rel="noopener">
                  <LinkedInIcon
                    sx={(theme) => ({ color: theme.palette.text.secondary, mt: '0.25rem' })}
                    fontSize="small"
                  />
              ...
              {socialLinks.chrunchBase && (
                <Link href={socialLinks.chrunchBase} target="_blank" rel="noopener">
                  <DisplaySettingsIcon
                    sx={(theme) => ({ color: theme.palette.text.secondary, mt: '0.25rem' })}
                    fontSize="small"
                  />
          ...
          <div className={styles.contactInfoBody}>
            {info.details?.contactName && (
              <Typography variant="body1" color="text.secondary">
                <b>Contact name</b>
                <br />
                {`${info.details.contactName.firstName} ${info.details.contactName.lastName ?? ''}`}
              </Typography>
            )}
